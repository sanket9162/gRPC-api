...
type Exec struct {
	...
	PassowrdChangeAt     string `protobuf:"password_change_at,omitempty" bson:"password_change_at,omitempty"`
	...
	PasswordTokenExpires string `protobuf:"password_token_expires,omitempty" bson:"password_token_expores,omitempty"`
